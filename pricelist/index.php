                  ...
                  <div class="card-body">
                     <table id="example1" class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                           <?php
                           $no = 1;
                           $ambildata = mysqli_query($conn, "SELECT p.*, c.nama_customer, c.top, u.fullname, s.nmsegment
                                   FROM pricelist p
                                   INNER JOIN customers c ON p.idcustomer = c.idcustomer
                                   INNER JOIN users u ON p.idusers = u.idusers
                                   INNER JOIN segment s ON c.idsegment = s.idsegment
                           ...
                           ?>
                              <tr>
                                 ...
                                 <td><?= $tampil['up']; ?></td>
                                 <td class="text-center"><?= $tampil['top'] . " " . "Hari"; ?></td>
                                 <td class="text-center"><?= $tampil['nmsegment']; ?></td>
