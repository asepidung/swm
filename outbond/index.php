            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover table-sm">
                ...
                <tbody>
                  <?php
                  $no = 1;
                  $ambildata = mysqli_query($conn, "SELECT a.*, u.userid FROM outbound a JOIN users u ON a.idusers = u.idusers ORDER BY nooutbound DESC; ");
                  ...
                  ?>
                    <tr data-widget="expandable-table" aria-expanded="false">
                      ...
                      <td class="text-center">
                        ...
                        <a href="deleteoutbound.php?idoutbound=<?= $tampil['idoutbound']; ?>" class="mx-auto p-2 text-danger" onclick="return confirm('apakah anda yakin ingin menghapus outbound ini?')"><i class="fas fa-times"></i> DELETE</a>
                      </td>
                    </tr>
