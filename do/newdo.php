                     ...
                     <form method="POST" action="cetakdo.php" onsubmit="submitForm(event)">
                        <!-- <div class="form-group">
                           ...
                           <div class="input-group">
                              <input type="text" class="form-control" name="so" id="so" readonly>
                           </div>
                        </div>
                        <div class="form-group">
                           <label for="do">NO DO</label>
                           <div class="input-group">
                              <input type="text" class="form-control" name="do" id="do" readonly>
                           </div>
                        </div> -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           <label for="catatando">Catatan pengiriman</label>
                           <div class="input-group">
                              <textarea name="catatando" id="catatando" class="form-control">-</textarea>
                           </div>
                        </div>
