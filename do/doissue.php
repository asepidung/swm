                           ...
                           while ($row_tallydetail = mysqli_fetch_assoc($result_tallydetail)) { ?>
                              <div class="row mb-n2">
                                 ...
                                 <div class="col-1">
                                    <div class="form-group">
                                       <div class="input-group">
                                          <input type="text" name="box[]" class="form-control text-center" readonly value="">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-2">
                                    <div class="form-group">
                                       <div class="input-group">
                                          <input type="text" name="weight[]" class="form-control text-right" readonly value="<?= $row_tallydetail['weight']; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col">
