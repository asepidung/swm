...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col mt-3">
          <form method="POST" action="inputinbound.php">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-2">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" value="<?= $noinbound ?>" name="noinbound" id="noinbound" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="col-2">
                  ...
                  <div class="col-2">
                    <div class="form-group">
                      <label for="deliverydate">Tanggal Inbound <span class="text-danger">*</span></label>
                      <div class="input-group">
                        <input type="date" class="form-control" name="tglinbound" id="tglinbound" required autofocus>
                      </div>
                    </div>
                  </div>
                  <div class="col">
