...
if (isset($_GET['id']) && isset($_GET['idboning'])) {
   ...
   if ($hapusdata) {
      ...
      echo "<script>alert('Data berhasil dihapus.'); window.location='labelboning.php?idboning=$idboning';</script>";
   } else {
      // Jika gagal, tampilkan pesan error
      echo "<script>alert('Maaf, terjadi kesalahan saat menghapus data.'); window.location='labelboning.php?idboning=$idboning';</script>";
   }
} else {
