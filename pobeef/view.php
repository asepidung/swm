...
// Ambil ID pobeef dari parameter GET
$idpo = $_GET['id'];

// Tampilkan data dari tabel pobeef berdasarkan idpo
...
$stmt_po->bind_param("i", $idpo);
$stmt_po->execute();
$result_po = $stmt_po->get_result();
$row_po = $result_po->fetch_assoc();

if (!$row_po) {
    die("PO Beef not found for the given id.");
}
