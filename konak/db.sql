...
(20) UNIQUE,
  ...
  iduser INT,
  FOREIGN KEY
(idbarang) REFERENCES barang
(idbarang),
  FOREIGN KEY
(iduser) REFERENCES users
(idusers),
  FOREIGN KEY
(idboning) REFERENCES boning
(idboning)
);
...
(255) DEFAULT '-',
  ...
  FOREIGN KEY
(idgroup) REFERENCES groupcs
(idgroup),
  FOREIGN KEY
(idsegment) REFERENCES segment
(idsegment)
);
...
(12.2),
  rweight DECIMAL
(12.2),
  xweightreceipt DECIMAL
(12, 2),
  idusers INT,
  created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY
(idcustomer) REFERENCES customers
(idcustomer),
  FOREIGN KEY
...
(255),
  FOREIGN KEY
(iddoreceipt) REFERENCES doreceipt
(iddoreceipt),
  FOREIGN KEY
(idgrade) REFERENCES grade
(idgrade),
...
(
  ...
  (
    idinvoicedetail INT PRIMARY KEY NOT NULL
    AUTO_INCREMENT,
  ...
  noadjustment VARCHAR
    (30) UNIQUE,
  tgladjustment DATE,
  eventadjustment VARCHAR
    (30),
  xweight DECIMAL
    (6,2),
  idusers INT,
  ...
  notes VARCHAR
    (255),
  FOREIGN KEY
    (idadjustment) REFERENCES adjustment
    (idadjustment),
  FOREIGN KEY
    (idgrade) REFERENCES grade
    (idgrade),
  ...
  notes VARCHAR
    (100),
  FOREIGN KEY
    (idoutbound) REFERENCES outbound
    (idoutbound),
  FOREIGN KEY
    (idgrade) REFERENCES grade
    (idgrade),
  ...
  notes VARCHAR
    (100),
  FOREIGN KEY
    (idreturjual) REFERENCES returjual
    (idreturjual),
  FOREIGN KEY
    (idgrade) REFERENCES grade
    (idgrade),
  ...
  bahan DECIMAL
    (12,2),
  FOREIGN KEY
    (idrepack) REFERENCES repack
    (idrepack),
  FOREIGN KEY
    (idgradebahan) REFERENCES grade
    (idgrade),
  FOREIGN KEY
    (idbarangbahan) REFERENCES barang
    (idbarang)
);
  ...
  FOREIGN KEY
    ...
    (idrepack),
  FOREIGN KEY
    (idgradehasil) REFERENCES grade
    (idgrade),
  FOREIGN KEY
    (idbaranghasil) REFERENCES barang
    (idbarang)
);
  ...
  notes VARCHAR
    (100),
  FOREIGN KEY
    (idpoproduct) REFERENCES poproduct
    (idpoproduct),
  FOREIGN KEY
    (idbarang) REFERENCES barang
    (idbarang)
  ...
  notes VARCHAR
    (255),
  FOREIGN KEY
    (idpricelist) REFERENCES pricelist
    (idpricelist),
  FOREIGN KEY
    (idbarang) REFERENCES barang
    (idbarang)
...
ADD FOREIGN KEY (idgroup) REFERENCES groupcs (idgroup);
  ...
  FOREIGN KEY
    ...
    CREATE TABLE cuts
    (
      idcut INT PRIMARY KEY NOT NULL
      AUTO_INCREMENT,
  nmcut VARCHAR
      (20)
);
...
ADD COLUMN idcut INT,
      ...
      ALTER TABLE barang
ADD FOREIGN KEY fk_idcut
      (idcut) REFERENCES cuts
      (idcut);